...
class Z80 {
    ...
    loadRom(romFile: File) {
        ...
        reader.onload = () => {
            ...
            const romByteArray = Array.from(new Uint8Array(reader.result as ArrayBuffer));
            this._mmu._rom = romByteArray;
        };
    }

    reset(): void {
        this.regs.a = 0; this.regs.b = 0; this.regs.c = 0; this.regs.d = 0;
        this.regs.e = 0; this.regs.h = 0; this.regs.l = 0; this.regs.f = 0;
        this.regs.sp = 0;
        this.regs.pc = 0;      // Start execution at 0
        this._clock.m = 0; this._clock.t = 0;
    }
    ...
    _ops = {
        ...
        LDHLIA: () => { this._mmu.wb((this.regs.h << 8) + this.regs.l, this.regs.a); this.regs.l = (this.regs.l + 1) & 255; if (!this.regs.l) this.regs.h = (this.regs.h + 1) & 255; this.regs.m = 2; this.regs.t = 8; },
        LDAHLI: () => { this.regs.a = this._mmu.rb((this.regs.h << 8) + this.regs.l); this.regs.l = (this.regs.l + 1) & 255; if (!this.regs.l) this.regs.h = (this.regs.h + 1) & 255; this.regs.m = 2; this.regs.t = 8; },

        LDHLDA: () => { this._mmu.wb((this.regs.h << 8) + this.regs.l, this.regs.a); this.regs.l = (this.regs.l - 1) & 255; if (this.regs.l == 255) this.regs.h = (this.regs.h - 1) & 255; this.regs.m = 2; this.regs.t = 8; },
        LDAHLD: () => { this.regs.a = this._mmu.rb((this.regs.h << 8) + this.regs.l); this.regs.l = (this.regs.l - 1) & 255; if (this.regs.l == 255) this.regs.h = (this.regs.h - 1) & 255; this.regs.m = 2; this.regs.t = 8; },
        ...
        LDHLSPn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; i += this.regs.sp; this.regs.h = (i >> 8) & 255; this.regs.l = i & 255; this.regs.m = 3; this.regs.t = 12; },
        ...
        /*--- Data processing ---*/
        ADDr_b: () => { this.regs.a += this.regs.b; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDr_c: () => { this.regs.a += this.regs.c; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDr_d: () => { this.regs.a += this.regs.d; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDr_e: () => { this.regs.a += this.regs.e; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDr_h: () => { this.regs.a += this.regs.h; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDr_l: () => { this.regs.a += this.regs.l; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDr_a: () => { this.regs.a += this.regs.a; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADDHL: () => { this.regs.a += this._mmu.rb((this.regs.h << 8) + this.regs.l); this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },
        ADDn: () => { this.regs.a += this._mmu.rb(this.regs.pc); this.regs.pc++; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },
        ADDHLBC: () => { var hl = (this.regs.h << 8) + this.regs.l; hl += (this.regs.b << 8) + this.regs.c; if (hl > 65535) this.regs.f |= 0x10; else this.regs.f &= 0xEF; this.regs.h = (hl >> 8) & 255; this.regs.l = hl & 255; this.regs.m = 3; this.regs.t = 12; },
        ADDHLDE: () => { var hl = (this.regs.h << 8) + this.regs.l; hl += (this.regs.d << 8) + this.regs.e; if (hl > 65535) this.regs.f |= 0x10; else this.regs.f &= 0xEF; this.regs.h = (hl >> 8) & 255; this.regs.l = hl & 255; this.regs.m = 3; this.regs.t = 12; },
        ADDHLHL: () => { var hl = (this.regs.h << 8) + this.regs.l; hl += (this.regs.h << 8) + this.regs.l; if (hl > 65535) this.regs.f |= 0x10; else this.regs.f &= 0xEF; this.regs.h = (hl >> 8) & 255; this.regs.l = hl & 255; this.regs.m = 3; this.regs.t = 12; },
        ADDHLSP: () => { var hl = (this.regs.h << 8) + this.regs.l; hl += this.regs.sp; if (hl > 65535) this.regs.f |= 0x10; else this.regs.f &= 0xEF; this.regs.h = (hl >> 8) & 255; this.regs.l = hl & 255; this.regs.m = 3; this.regs.t = 12; },
        ADDSPn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.sp += i; this.regs.m = 4; this.regs.t = 16; },

        ADCr_b: () => { this.regs.a += this.regs.b; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCr_c: () => { this.regs.a += this.regs.c; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCr_d: () => { this.regs.a += this.regs.d; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCr_e: () => { this.regs.a += this.regs.e; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCr_h: () => { this.regs.a += this.regs.h; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCr_l: () => { this.regs.a += this.regs.l; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCr_a: () => { this.regs.a += this.regs.a; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        ADCHL: () => { this.regs.a += this._mmu.rb((this.regs.h << 8) + this.regs.l); this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },
        ADCn: () => { this.regs.a += this._mmu.rb(this.regs.pc); this.regs.pc++; this.regs.a += (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a); if (this.regs.a > 255) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },

        SUBr_b: () => { this.regs.a -= this.regs.b; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBr_c: () => { this.regs.a -= this.regs.c; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBr_d: () => { this.regs.a -= this.regs.d; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBr_e: () => { this.regs.a -= this.regs.e; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBr_h: () => { this.regs.a -= this.regs.h; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBr_l: () => { this.regs.a -= this.regs.l; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBr_a: () => { this.regs.a -= this.regs.a; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SUBHL: () => { this.regs.a -= this._mmu.rb((this.regs.h << 8) + this.regs.l); this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },
        SUBn: () => { this.regs.a -= this._mmu.rb(this.regs.pc); this.regs.pc++; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },

        SBCr_b: () => { this.regs.a -= this.regs.b; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCr_c: () => { this.regs.a -= this.regs.c; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCr_d: () => { this.regs.a -= this.regs.d; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCr_e: () => { this.regs.a -= this.regs.e; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCr_h: () => { this.regs.a -= this.regs.h; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCr_l: () => { this.regs.a -= this.regs.l; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCr_a: () => { this.regs.a -= this.regs.a; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 1; this.regs.t = 4; },
        SBCHL: () => { this.regs.a -= this._mmu.rb((this.regs.h << 8) + this.regs.l); this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },
        SBCn: () => { this.regs.a -= this._mmu.rb(this.regs.pc); this.regs.pc++; this.regs.a -= (this.regs.f & 0x10) ? 1 : 0; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },

        CPr_b: () => { var i = this.regs.a; i -= this.regs.b; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPr_c: () => { var i = this.regs.a; i -= this.regs.c; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPr_d: () => { var i = this.regs.a; i -= this.regs.d; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPr_e: () => { var i = this.regs.a; i -= this.regs.e; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPr_h: () => { var i = this.regs.a; i -= this.regs.h; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPr_l: () => { var i = this.regs.a; i -= this.regs.l; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPr_a: () => { var i = this.regs.a; i -= this.regs.a; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 1; this.regs.t = 4; },
        CPHL: () => { var i = this.regs.a; i -= this._mmu.rb((this.regs.h << 8) + this.regs.l); this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 2; this.regs.t = 8; },
        CPn: () => { var i = this.regs.a; i -= this._mmu.rb(this.regs.pc); this.regs.pc++; this._ops.fz(i, 1); if (i < 0) this.regs.f |= 0x10; i &= 255; this.regs.m = 2; this.regs.t = 8; },
        ...
        INCBC: () => { this.regs.c = (this.regs.c + 1) & 255; if (!this.regs.c) this.regs.b = (this.regs.b + 1) & 255; this.regs.m = 1; this.regs.t = 4; },
        INCDE: () => { this.regs.e = (this.regs.e + 1) & 255; if (!this.regs.e) this.regs.d = (this.regs.d + 1) & 255; this.regs.m = 1; this.regs.t = 4; },
        INCHL: () => { this.regs.l = (this.regs.l + 1) & 255; if (!this.regs.l) this.regs.h = (this.regs.h + 1) & 255; this.regs.m = 1; this.regs.t = 4; },
        INCSP: () => { this.regs.sp = (this.regs.sp + 1) & 65535; this.regs.m = 1; this.regs.t = 4; },

        DECBC: () => { this.regs.c = (this.regs.c - 1) & 255; if (this.regs.c == 255) this.regs.b = (this.regs.b - 1) & 255; this.regs.m = 1; this.regs.t = 4; },
        DECDE: () => { this.regs.e = (this.regs.e - 1) & 255; if (this.regs.e == 255) this.regs.d = (this.regs.d - 1) & 255; this.regs.m = 1; this.regs.t = 4; },
        DECHL: () => { this.regs.l = (this.regs.l - 1) & 255; if (this.regs.l == 255) this.regs.h = (this.regs.h - 1) & 255; this.regs.m = 1; this.regs.t = 4; },
        ...
        NEG: () => { this.regs.a = 0 - this.regs.a; this._ops.fz(this.regs.a, 1); if (this.regs.a < 0) this.regs.f |= 0x10; this.regs.a &= 255; this.regs.m = 2; this.regs.t = 8; },
        ...
        JPNZnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x80) == 0x00) { this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m++; this.regs.t += 4; } else this.regs.pc += 2; },
        JPZnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x80) == 0x80) { this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m++; this.regs.t += 4; } else this.regs.pc += 2; },
        JPNCnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x10) == 0x00) { this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m++; this.regs.t += 4; } else this.regs.pc += 2; },
        JPCnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x10) == 0x10) { this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m++; this.regs.t += 4; } else this.regs.pc += 2; },

        JRn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.m = 2; this.regs.t = 8; this.regs.pc += i; this.regs.m++; this.regs.t += 4; },
        JRNZn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.m = 2; this.regs.t = 8; if ((this.regs.f & 0x80) == 0x00) { this.regs.pc += i; this.regs.m++; this.regs.t += 4; } },
        JRZn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.m = 2; this.regs.t = 8; if ((this.regs.f & 0x80) == 0x80) { this.regs.pc += i; this.regs.m++; this.regs.t += 4; } },
        JRNCn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.m = 2; this.regs.t = 8; if ((this.regs.f & 0x10) == 0x00) { this.regs.pc += i; this.regs.m++; this.regs.t += 4; } },
        JRCn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.m = 2; this.regs.t = 8; if ((this.regs.f & 0x10) == 0x10) { this.regs.pc += i; this.regs.m++; this.regs.t += 4; } },

        DJNZn: () => { var i = this._mmu.rb(this.regs.pc); if (i > 127) i = -((~i + 1) & 255); this.regs.pc++; this.regs.m = 2; this.regs.t = 8; this.regs.b--; if (this.regs.b) { this.regs.pc += i; this.regs.m++; this.regs.t += 4; } },
        ...
        CALLNZnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x80) == 0x00) { this.regs.sp -= 2; this._mmu.ww(this.regs.sp, this.regs.pc + 2); this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m += 2; this.regs.t += 8; } else this.regs.pc += 2; },
        CALLZnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x80) == 0x80) { this.regs.sp -= 2; this._mmu.ww(this.regs.sp, this.regs.pc + 2); this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m += 2; this.regs.t += 8; } else this.regs.pc += 2; },
        CALLNCnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x10) == 0x00) { this.regs.sp -= 2; this._mmu.ww(this.regs.sp, this.regs.pc + 2); this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m += 2; this.regs.t += 8; } else this.regs.pc += 2; },
        CALLCnn: () => { this.regs.m = 3; this.regs.t = 12; if ((this.regs.f & 0x10) == 0x10) { this.regs.sp -= 2; this._mmu.ww(this.regs.sp, this.regs.pc + 2); this.regs.pc = this._mmu.rw(this.regs.pc); this.regs.m += 2; this.regs.t += 8; } else this.regs.pc += 2; },
        ...
        RETNZ: () => { this.regs.m = 1; this.regs.t = 4; if ((this.regs.f & 0x80) == 0x00) { this.regs.pc = this._mmu.rw(this.regs.sp); this.regs.sp += 2; this.regs.m += 2; this.regs.t += 8; } },
        RETZ: () => { this.regs.m = 1; this.regs.t = 4; if ((this.regs.f & 0x80) == 0x80) { this.regs.pc = this._mmu.rw(this.regs.sp); this.regs.sp += 2; this.regs.m += 2; this.regs.t += 8; } },
        RETNC: () => { this.regs.m = 1; this.regs.t = 4; if ((this.regs.f & 0x10) == 0x00) { this.regs.pc = this._mmu.rw(this.regs.sp); this.regs.sp += 2; this.regs.m += 2; this.regs.t += 8; } },
        RETC: () => { this.regs.m = 1; this.regs.t = 4; if ((this.regs.f & 0x10) == 0x10) { this.regs.pc = this._mmu.rw(this.regs.sp); this.regs.sp += 2; this.regs.m += 2; this.regs.t += 8; } },
        ...
        /*--- Helper functions ---*/
        fz: (i: any, as?: any) => { this.regs.f = 0; if (!(i & 255)) this.regs.f |= 128; this.regs.f |= as ? 0x40 : 0; },
        MAPcb: () => {
            var i = this._mmu.rb(this.regs.pc); this.regs.pc++;
            this.regs.pc &= 65535;
